        ...
        <View style={{ padding: 24, flex: 1, backgroundColor: 'white' }}>
            ...
            <View style={{ marginTop: 30 }}>
                <View style={{ backgroundColor: '#F6F7F7', padding: 5, borderRadius: 6, marginTop: 14 }}>
                    <Pressable style={{ backgroundColor: '#F6F7F7', padding: 5, borderRadius: 4, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }} onPress={() => navigation.navigate('MuscleGroup',{MuscleGroup:"biceps"})}>
                        <View>
            ...
            <View style={{ backgroundColor: '#F6F7F7', padding: 5, borderRadius: 6, marginTop: 14 }}>
                <Pressable style={{ backgroundColor: '#F6F7F7', padding: 5, borderRadius: 4, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }} onPress={() => navigation.navigate('MuscleGroup',{MuscleGroup:"triceps"})}>
                    <View>
